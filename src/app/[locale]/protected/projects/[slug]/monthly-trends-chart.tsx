...
export const MonthlyTrendsChart = ({
  ...
  if (results.length === 0)
    return <div className="pt-2 italic">暂无数据</div>;
...
const MonthSummary = ({
  ...
  return (
    <div>
      {year}年 {monthNames[month - 1]}: {formattedValue} {unit}
    </div>
  );
};
...
const GraphBar = ({
  ...
  return (
    <>
      ...
      <div
        className="mt-1 w-3/4 max-w-8 bg-linear-to-b from-[var(--graphBackgroundColor1)] to-[var(--graphBackgroundColor2)]"
        style={{ height }}
